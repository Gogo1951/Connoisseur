...
-- Max stack by client, from each item's Wowhead tooltip on classic and tbc.
local STACKS = {
	era = {
		[8766] = 20,
		[8950] = 20,
...
local function session(classToken, level, client)
	...
	local ns = { CURRENT_EXPANSION = EXPANSION[client], EXPANSION_CLASSIC = 0, EXPANSION_TBC = 1, EXPANSION_WRATH = 2 }
	...
	-- The numbering from Data/Pet-Foods.lua and Data/Poisons.lua, without the rest of those files.
	ns.PET_DIET_MAP = { Meat = 1, Fish = 2, Bread = 3, Cheese = 4, Fruit = 5, Fungus = 6 }
	ns.POISON_GROUPS = { ANESTHETIC = 1, CRIPPLING = 2, DEADLY = 3, INSTANT = 4, MIND_NUMBING = 5, WOUND = 6 }

	-- What the pop-up takes from Options/Options-Utilities.lua and Data/Data.lua.
	...
	ns.CLASS_COLORS = { ROGUE = "fff569" }
	ns.OPTIONS_REGISTRY = { StarterListPopup = "Connoisseur_StarterListPopup" }
	...
	loadAddonFile("Data/Starter-List-Categories.lua")
