...
ns.POTIONS = {
	...
	-- Enriched Lasher Root (23329) is absent on purpose: its live row is in Healthstones-Mists.lua, sharing the Healthstone cooldown category.
	...
	-- Whipper Root Tuber (11951) is absent on purpose: its live row is in Healthstones-Mists.lua, sharing the Healthstone cooldown category.
}
