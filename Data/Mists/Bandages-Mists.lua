...
--[[
    Source: copied from Data/Wrath/Bandages-Wrath.lua: the rows a Wrath
...
ns.BANDAGES = {
	...
	-- Dense Runecloth Bandage (232433) is deliberately absent; it is a Season of Discovery item.
