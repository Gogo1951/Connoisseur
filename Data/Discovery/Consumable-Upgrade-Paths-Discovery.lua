...
--[[
    ...
    FoodType at all, which is also why they are absent from Pet-Foods-Discovery.lua.
]]
...
ns.CONSUMABLE_UPGRADE_CHAINS = {
	...
	},
	{
		--[[
		    ...
		    under FoodType 6 and the database is simply wrong -- Pet-Foods-Discovery.lua
	...
	--[[
	    ...
	    The tier rows mirror ns.POISON_DATA (Poisons-Discovery.lua), which the
	...
	},
	{
		...
		tiers = {
			{ 34, 5530, 1 }, -- Blinding Powder (Blind)
		},
	},
	{
		kind = "reagent",
