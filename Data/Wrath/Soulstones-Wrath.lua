...
--[[
    ...
    Conjured-Items-Wrath.lua): soulstones share a 30-minute use cooldown that
...
--[[
    ...
    (Conjure-Spells-Wrath.lua), which are what a warlock casts to MAKE one,
...
ns.SOULSTONE_BUFF_SPELL_IDS = {
	...
	47883, -- Rank 7, Demonic  (conjure 47884)
}
