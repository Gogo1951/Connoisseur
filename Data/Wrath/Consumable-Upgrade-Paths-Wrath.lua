...
--[[
    Source: the tiers a Wrath client accepted in the pre-split shared
    Data/Consumable-Upgrade-Paths.lua, its Wrath-tagged tiers included, until a
    Wrath TOC ships and Validate Data runs there.
...
--[[
    ...
    FoodType at all, which is also why they are absent from Pet-Foods-Wrath.lua.
]]
...
ns.CONSUMABLE_UPGRADE_CHAINS = {
	{
		...
		tiers = {
			...
			{ 65, 35954, 9 }, -- Sweetened Goat's Milk
			{ 70, 33444, 10 }, -- Pungent Seal Whey
			{ 75, 33445, 11 }, -- Honeymint Tea
		},
	},
	{
		kind = "food",
		...
		tiers = {
			...
			{ 65, 33454, 9 }, -- Salted Venison
			{ 75, 35953, 10 }, -- Mead Basted Caribou
		},
	},
	{
		kind = "food",
		...
		tiers = {
			...
			{ 65, 33451, 9 }, -- Fillet of Icefin
			{ 75, 35951, 10 }, -- Poached Emperor Salmon
		},
	},
	{
		--[[
		    Homemade Cherry Pie is BREAD, not fruit. item_template files it
		    under FoodType 6 and the database is simply wrong -- Pet-Foods-Wrath.lua
		...
		tiers = {
			...
			{ 65, 33449, 9 }, -- Crusty Flatbread
			{ 75, 35950, 10 }, -- Sweet Potato Bread
		},
	},
	{
		kind = "food",
		...
		tiers = {
			...
			{ 65, 33443, 9 }, -- Sour Goat Cheese
			{ 75, 35952, 10 }, -- Briny Hardcheese
		},
	},
	{
		--[[
		...
		tiers = {
			...
			{ 65, 35949, 9 }, -- Tundra Berries
			{ 75, 35948, 10 }, -- Savory Snowplum
		},
	},
	{
		kind = "food",
		...
		tiers = {
			...
			{ 65, 33452, 9 }, -- Honey-Spiced Lichen
			{ 75, 35947, 10 }, -- Sparkling Frostcap
		},
	},
	...
	--[[
	    ...
	    The tier rows mirror ns.POISON_DATA (Poisons-Wrath.lua), which the
	...
	]]
	{
		...
		tiers = {
			...
			{ 77, 43237, 2 }, -- Anesthetic Poison II
		},
	},
	{
		kind = "poison",
	...
	},
	{
		...
		tiers = {
			...
			{ 76, 43232, 8 }, -- Deadly Poison VIII
			{ 80, 43233, 9 }, -- Deadly Poison IX
		},
	},
	{
		kind = "poison",
		...
		tiers = {
			...
			{ 73, 43230, 8 }, -- Instant Poison VIII
			{ 79, 43231, 9 }, -- Instant Poison IX
		},
	},
	{
		kind = "poison",
	...
	},
	{
		...
		tiers = {
			...
			{ 72, 43234, 6 }, -- Wound Poison VI
			{ 78, 43235, 7 }, -- Wound Poison VII
		},
	},
	...
	},
	{
		...
		reagent = "corpse-dust",
		tiers = {
			{ 55, 37201, 1 }, -- Corpse Dust (Raise Dead)
		},
	},
	{
	...
	]]
	{
		...
		tiers = {
			...
			{ 70, 33447, 8 }, -- Runic Healing Potion
		},
	},
	{
		kind = "mana-potion",
