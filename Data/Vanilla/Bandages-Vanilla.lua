...
--[[
    ...
    Crystal Infused Bandage (23684) came from the wago.tools tables for build
...
ns.BANDAGES = {
	...
	-- Dense Runecloth Bandage (232433) is deliberately absent; it is a Season of Discovery item that Validate Data reports OK on Era only because the two share one client.
