...
L["MESSAGE_MACRO_SLOTS_FULL"] =
	"No se pudieron crear algunas macros de Connoisseur porque tus espacios para macros están llenos. Libera un espacio borrando macros que ya no uses, o desactiva las macros de Connoisseur que no necesites en Opciones > Addons > Connoisseur."
...
L["STARTER_POPUP_REAGENT_FLASH_POWDER"] = "Part. explosivas"
...
L["RESTOCKER_REPUTATION_TOOLTIP_STANDING"] =
	'Haz clic para elegir la reputación necesaria con un mercader antes de que Connoisseur le compre ("Cualquiera" compra en cualquier lugar), lo que además rebaja el precio: Amistoso 5%, Honorable 10%, Reverenciado 15%, Exaltado 20%.'
