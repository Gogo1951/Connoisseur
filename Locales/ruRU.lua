...
L["CHAT_LOADED"] = "Версия @project-version@. Настройки (включая возможность отключения этого сообщения) находятся в Настройки > Модификации > Connoisseur. Нравится аддон? Расскажите другу! (="
...
L["OPTIONS_DESC"] = "Автоматически обновляемые макросы для вашей лучшей еды, еды с баффами, воды, свитков, лечебных зелий и зелий маны, камней здоровья, камней души, мана-камней и бинтов. Сотворение в один клик для Магов и Чернокнижников, умное Кормление питомца для Охотников. Оптимальное питание, пиковая эффективность."

-- Welcome Message
L["OPTIONS_WELCOME_MESSAGE"] = "Включить приветственное сообщение"
L["OPTIONS_WELCOME_MESSAGE_DESC"] = "Выводить приветственное сообщение в чат при входе в игру."
...
L["OPTIONS_DRUID_MACRO_HELPER_DESC"] = "Создает макросы смены облика для лечебных зелий, зелий маны и камней здоровья с помощью DruidMacroHelper (/dmh)."
