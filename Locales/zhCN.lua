...
L["TIP_HUNTER_FEED_PET"] =
	"喂养宠物是一个多合一的宠物按钮！点击可自动召唤、喂养或复活你的宠物。右键点击或等待战斗来施放治疗宠物。按住Shift强制复活，按住Ctrl解散。"
...
L["TIP_WARLOCK_CONJURE"] =
	"右键点击你的治疗石或灵魂石宏以制造治疗石或灵魂石。再次右键点击你的治疗石宏以制造一颗低等级备用治疗石。"
L["TIP_WARLOCK_SOUL"] = "中键点击以施放灵魂仪式。"
L["TIP_ROGUE_POISONS"] =
	"左键点击为副手武器涂抹毒药，右键点击为主手武器涂抹。已有毒药会自动替换。中键点击打开毒药窗口。"
...
L["OPTIONS_DESCRIPTION"] =
	"为你最好的食物、增益食物、水、卷轴、治疗和法力药水、治疗石、灵魂石、法力宝石和绷带创建自动更新的宏。为法师和术士提供一键制造，为猎人提供智能喂食。最佳营养，巅峰表现。"
...
L["OPTIONS_USE_SCROLLS_DESCRIPTION"] =
	"只要你缺少卷轴增益，就会将你的食物宏转变为专用的卷轴施放器。按一次施放卷轴；再按一次进食。卷轴不占用GCD，以你为目标，并且当你的目标是其他友方玩家时，宏会立刻还原为食物。"
...
L["OPTIONS_USE_PET_BUFFS_DESCRIPTION"] =
	'当你的宠物缺少 "进食充分" BUFF时，在你的食物宏中使用宠物食物。'
...
L["RESTOCKER_COMPLETE"] = "补货完成。下次按住 Shift 可跳过。输入 %s 编辑你的补货清单。"
...
L["RESTOCKER_FINISHED_RESTOCKING"] = "补货结束（完成 %d 笔购买）。"
